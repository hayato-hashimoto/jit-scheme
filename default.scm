...
(define (cons x y) (ior (+ 0 #x0100000000000000) (pair x y)))
(define (atom? x)  (and (+ 0 #x0100000000000000) x))
...
(define last ((fn (self)
  ...
  self)))
(define map ((fn (self)
  (set! self (fn (proc lis) (if (atom? lis) '() (cons (proc (car lis)) (self proc (cdr lis))))))
  self)))
